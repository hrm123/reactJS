...
and then 'json-server --watch db.json --port 3004' command in a separate terminal window.
 ...
 http://jsonplaceholder.typicode.com/users?website=hildegard.org
 http://jsonplaceholder.typicode.com/users?company.name=Romaguera-Crona
 
 local data queries:
 http://localhost:3000/questions
 http://localhost:3000/questions/2aaf0b0d-109a-431b-86a1-7a83ff44fce5
 http://localhost:3000/questions/?step=1
 
 2. Uses https://www.npmjs.com/package/eslint-config-airbnb for linting